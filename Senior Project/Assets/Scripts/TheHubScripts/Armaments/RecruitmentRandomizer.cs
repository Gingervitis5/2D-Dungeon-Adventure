        ...
        for (int i = 1; i <= NumRecruits && !HasRandomized; i++)
        {
            ...
            switch (RecruitType)
            {
                ...
                case 3: //Scholar
                    ...
                    break;
                case 4: //Psionic
                    //NewRecruitObject = GameObject.Instantiate(PsionicPrefab);
                    //NewRecruitObject.transform.SetParent(ListContent.transform);
                    //Recruits.Add(NewRecruitObject);
                    break;
                case 5: //Soldier
                    //NewRecruitObject = GameObject.Instantiate(SoldierPrefab);
                    //NewRecruitObject.transform.SetParent(ListContent.transform);
                    //Recruits.Add(NewRecruitObject);
                    break;
                case 6: //Operative
                    //NewRecruitObject = GameObject.Instantiate(OperativePrefab);
                    //NewRecruitObject.transform.SetParent(ListContent.transform);
                    //Recruits.Add(NewRecruitObject);
                    break;
                case 7: //Delegate
                    //NewRecruitObject = GameObject.Instantiate(DelegatePrefab);
                    //NewRecruitObject.transform.SetParent(ListContent.transform);
                    //Recruits.Add(NewRecruitObject);
                    break;
            }
